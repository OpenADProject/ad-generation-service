...
# 📌 프로젝트 개요
디지털 마케딩의 높은 장벽을 허무는 것을 목표로 합니다. IT 기기나 복잡한 설명서가 낯선 부모님 세대나 소상공인도, 단 몇 번의 클릭만으로 자신의 상황에 꼭 맞는 전문가 수준의 광고 콘텐츠를 즉시 생성할 수 있는 가장 직관적인 AI 서비스를 만듭니다.
...
* 빠르게 광고 문구를 테스트하고 싶은 소셜 미디어 마케터
